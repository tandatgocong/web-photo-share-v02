...
<div class="Content">
    <div class="News_Left">            
        <div class="title_page">User Profile</div>
                    ...
                    <td>
                        <table align="center" width="90%" style="" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td width="5">&nbsp;</td>
                                <td align="left">tandatgocong </td>
                            </tr>
                            <tr>
                                <td width="120">Password: </td>
                                <td width="5">&nbsp;</td>
                                <td align="left">******************* <a href="#"><i><font size="2" > Change Password</font></i></a> </td>
                            </tr>
                    ...
                    <td>
                        <table align="center" width="90%" style="" border="0" cellpadding="0" cellspacing="0">
                            <tr class="row_list">
                                ...
                                <td width="5">&nbsp;</td>
                                <td align="left"><input type="text" value="DAT" width="250px"></td>
                            </tr>
                            <tr class="row_list">
                                <td width="120">Last Name:</td>
                                <td width="5">&nbsp;</td>
                                <td align="left"><input type="text" value="LE TAN" width="250"></td>
                            </tr>
                            <tr class="row_list">
                                <td width="120">Birthday:</td>
                                <td width="5">&nbsp;</td>
                                <td align="left"><input type="text" value="11/30/1988"><img src="<%=request.getContextPath()%>/stylesheets/images/calendar.gif"  align="top" width="17" height="18"></td>
                            </tr>
                            <tr class="row_list">
                                <td width="120">Sex:</td>
                                <td width="5">&nbsp;</td>
                            ...
                            <tr class="row_list">
                                ...
                                <td width="5">&nbsp;</td>
                                <td align="left"><input type="text" value="7 DAN TOC - TAN THANH - TAN PHU"></td>
                            </tr>
                            <tr class="row_list">
                                <td width="120">Phone Number:</td>
                                <td width="5">&nbsp;</td>
                                <td align="left"><input type="text" value="0937380505"></td>
                            </tr>
                            <tr class="row_list">
                                <td width="120">Email Address:</td>
                                <td width="5">&nbsp;</td>
                                <td align="left"><input type="text" value="tandatgocong@gmail.com"></td>
                            </tr>
                            <tr class="row_list">
                                ...
                                <td align="left">
                                    <select >
                                        <option value="">What is the first nam of your favorite uncle ?
                                        </option>
                            ...
                            <tr class="row_list">
                                ...
                                <td width="5">&nbsp;</td>
                                <td align="left"><input type="text" value="hihi"></td>
                            </tr>
                            <tr  class="row_list">
                                <td>Verify Code:</td>
                                <td width="5"> </td>
