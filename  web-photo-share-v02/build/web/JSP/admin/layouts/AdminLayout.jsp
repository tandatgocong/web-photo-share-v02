...
<html>
    ...
    <body>
        <div id="Main" >
            <tiles:insert attribute="AdminWebPhoto.header" />
            <tiles:insert attribute="AdminWebPhoto.menu" />
            <tiles:insert attribute="AdminWebPhoto.body" />
            <tiles:insert attribute="AdminWebPhoto.footer" />
        </div>
